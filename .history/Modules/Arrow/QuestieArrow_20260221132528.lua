...
function QuestieArrow:UpdateNearestTargets()
    ...
    local function _CollectQuestTargets(quest)
        ...
        if quest.isComplete or QuestieDB.IsComplete(quest.Id) == 1 then
            if quest.Id == 12843 or quest.Id == 12844 then
                print("QuestieArrow: Quest Complete logic entered for " .. tostring(quest.name))
            end
                                ...
                                if uiMapId then
                                    ...
                                    if targetX and targetY and targetInstance then
                                        ...
                                        if dist then
                                            ...
                                            if quest.Id == 12843 or quest.Id == 12844 then
                                                print("QuestieArrow: Adding OBJECTIVE for " .. tostring(quest.name) .. " at distance: " .. tostring(dist))
                                            end
