    ...
    local function _CollectQuestTargets(quest)
        ...
        if quest.isComplete or QuestieDB.IsComplete(quest.Id) == 1 then
            ...
            local function _CollectFinisherSpawns(finisher)
                                    ...
                                    if usingAutoLogic and finisherZone ~= playerZoneId then
                                        ...
                                        if uiMapId then
                                            ...
                                            if quest.Id == 12843 or quest.Id == 12844 then
                                                print("QuestieArrow Finisher check:")
                                                print("  uiMapId:", uiMapId, "x:", x, "y:", y)
                                                print("  targetX:", targetX, "targetY:", targetY, "instance:", targetInstance)
                                            end
                                                ...
                                                if dist then
                                                    ...
                                                    if quest.Id == 12843 or quest.Id == 12844 then
                                                        print("QuestieArrow: Adding FINISHER for " .. tostring(quest.name) .. " at distance: " .. tostring(dist))
                                                    end
                ...
                if quest.Id == 12843 or quest.Id == 12844 then
                    print("QuestieArrow: Before Finisher check. Finisher exists: " .. tostring(quest.Finisher ~= nil))
                    if quest.Finisher then
                        print("QuestieArrow: Finisher.Id: " .. tostring(quest.Finisher.Id) .. ", Finisher.Type: " .. tostring(quest.Finisher.Type))
                    end
                end

                if quest.Finisher and quest.Finisher.Name then
                    local finisher
                    ...
                    if quest.Id == 12843 or quest.Id == 12844 then
                        print("QuestieArrow: Calling _CollectFinisherSpawns for " .. tostring(quest.name) .. ". Finisher ID: " .. tostring(quest.Finisher.Id) .. " Type: " .. tostring(quest.Finisher.Type) .. " Finisher Object: " .. tostring(finisher and finisher.name or "nil"))
                    end
