...
function QuestieWotlkQuestFixes:Load()
    ...
    return {
        ...
        [11957] = {
            [questKeys.requiredSourceItems] = {35671,35690},
            [questKeys.extraObjectives] = {
        ...
        [13345] = {
            [questKeys.sourceItemId] = 44459,
            [questKeys.preQuestSingle] = {13318},
        },
        [13346] = {
            [questKeys.sourceItemId] = 44476,
